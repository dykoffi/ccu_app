    ...
    return (
        <div className="col-12">
            ...
            <div className="row d-flex flex-column p-5">
                ...
                <p><b>CCU</b> met à votre dispositon des outils qui vous permettront de facilement actualiser tous vos contacts et ainsi vous adapter rapidement et sans effort au changement.</p>
            </div>
